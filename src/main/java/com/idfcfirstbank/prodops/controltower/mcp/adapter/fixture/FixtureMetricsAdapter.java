...
import com.idfcfirstbank.prodops.controltower.mcp.adapter.fixture.FixtureScenarioLoader.FixtureMetricBundle;
...
public class FixtureMetricsAdapter implements MetricsPort {
  ...
  @Override
  public List<com.idfcfirstbank.prodops.controltower.mcp.domain.model.MetricValue> goldenSignals(
      String cluster,
      String namespace,
  ...
  public PromqlExecutionResult instantQuery(String cluster, String query, Instant evaluationTime) {
    List<com.idfcfirstbank.prodops.controltower.mcp.domain.model.MetricSeries> series =
